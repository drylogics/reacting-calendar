...
describe("Header", () => {
  ...
  it("should display month and year", () => {
    expect(wrapper.find("th.datepicker-switch").text()).to.equal(
      mayFifth.format("MMMM YYYY")
    );
  });
  ...
  it("should display weekday labels in header for days selection", () => {
    ...
    expect(wrapper.find("th.dow").map(th => th.text())).to.deep.equal([
      "SU",
      "MO",
      "TU",
      "WE",
...
describe("Calendar", () => {
  ...
  it("should pass props correctly to Header", () => {
    const wrapper = mount(
      <Calendar name="Start Date" selectedDate="2017-05-05" />
    );
    expect(wrapper.find("Header"))
      .to.have.prop("visibleDate")
      .deep.equal(mayFifth);
  });
  ...
  it("should pass props correctly to Days", () => {
    ...
    expect(wrapper.find("Days"))
      .to.have.prop("selectedDate")
      .deep.equal(mayFifth);
    expect(wrapper.find("Days"))
      .to.have.prop("visibleDate")
      .deep.equal(mayFifth);
  ...
  it("should pass props correctly to Months", () => {
    const wrapper = mount(
      <Calendar
        name="Start Date"
        selectedDate="2017-05-05"
        currentView="months"
      />
    );
    expect(wrapper.find("Months"))
      .to.have.prop("selectedDate")
      .deep.equal(mayFifth);
    expect(wrapper.find("Months"))
      .to.have.prop("visibleDate")
...
describe("Calendar Navigation", () => {
  ...
  it("should show next month on right navigation on days view", () => {
    const wrapper = mount(
      <Calendar name="Start Date" selectedDate="2017-12-05" />
    );
    expect(wrapper.find("th.datepicker-switch").text()).to.equal(
      "December 2017"
    );
...
describe("Calendar Input", () => {
  ...
  it("should pass input text as selectedDate state to Calendar Component", () => {
    ...
    expect(wrapper.state("selectedDate").format("YYYY-MM-DD")).to.equal(
      "2018-02-25"
    );
  });
